      ...
      <v-col class="align-center">
        <v-row class="align-center" justify="center">
          <v-col cols="12" sm="10" md="10" lg="6" class="align-center">
            <v-alert v-if="showMsg === 'error'" dismissible :value="true" type="error">
            ...
            <v-card class="login-card">
              ...
              <v-card-text>
                <v-form ref="form" lazy-validation>
                  ...
                  <v-btn v-if="!isUpdate" class="blue white--text"
                  @click="createInvestment">Save</v-btn>
                  <v-btn v-if="isUpdate" class="blue white--text"
                  @click="updateInvestment">Update</v-btn>
