...
<td align="center">
  <v-icon :id="'deleteIcon-' + props.item.pk" class="small" @click.stop="popupId = props.item.pk; dialog = true;">mdi-delete</v-icon>
...
apiService.deleteCustomer(customer).then(response => {
