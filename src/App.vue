  ...
  <v-app>
    ...
    <div class="hidden-xs-only">
      <v-btn
        ...
        text
        rounded
        dark>{{ item.title }}</v-btn>
      <v-btn text dark text rounded v-if="!authenticated" @click="login">Log in</v-btn>
      <v-btn text dark text rounded v-if="!authenticated" @click="registration">Register</v-btn>
      <v-btn text dark text rounded v-if="authenticated" @click="logout">Log Out</v-btn>
    </div>
    <div class="hidden-sm-and-up">
      <v-menu bottom left>
        ...
        <v-list>
          ...
          <v-list-item v-if="!authenticated" @click="registration">Register</v-list-item>
